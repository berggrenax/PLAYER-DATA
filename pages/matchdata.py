# pages/matchdata.py
# Körs som undersida till app.py
...
def render():
   # --------- SIDHUVUD ----------
    ...
    # Kolla att man är inloggad via app.py
    if not st.session_state.get("logged_in", False):
        st.warning("Du måste logga in på huvudsidan först.")
        st.stop()

    # --------- RESTEN AV DIN MATCHDATA-KOD UNDER DETTA ----------
    # (hjälpfunktioner, Google Sheets, grafer osv – allt du hade innan)
